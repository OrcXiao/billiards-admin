      ...
      <el-form :model="login" :rules="loginRules" ref="login">
        ...
        <el-form-item prop="authCode">
          <div class="dis-fl auth-wrap">
            <el-input class="auth-input" maxlength="20" v-model="login.authCode" placeholder="请输入验证码"></el-input>
            <div class="auth-code" title="点击更换验证码" @click="getAuthCode">
              <img class="wd100 hg100 cu-pt" :src="verificationCode"
                   alt="验证码">
            </div>
          </div>
        </el-form-item>
        <el-form-item>
          <el-button :loading="btnLoginState" @click="submitLogin('login')" class="wd100" type="primary">登 录</el-button>
        </el-form-item>
      </el-form>
      <!--        </el-tab-pane>-->
